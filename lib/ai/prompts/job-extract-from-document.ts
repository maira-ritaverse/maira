...
6. **description の 集約方針**(これが 最重要)。
   description は 求人の 「全体像」を まとめる メイン項目。下記の 順で 構造化し、見出しは ★ 印で 区切る。原文の 体裁を 完璧に 残す 必要は ない が、求職者が 1 度 読んで 理解できる 文章に する。最大 5000 字。
...
・description には 仕事内容 だけでなく、募集背景 / 配属先 / ポイント / 特徴 / 給与備考 / 福利厚生 / 会社情報 / 求人ID も ★ 見出しで 区切って 集約してください(5000 字以内)。
