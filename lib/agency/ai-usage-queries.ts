...
import {
  ...
  AGENCY_INTERVIEW_PREP_FREE_MONTHLY,
...
export const AI_KIND_FREE_DEFAULT: Record<AiUsageKind, number> = {
  ...
  agency_line_client_extract: AGENCY_LINE_CLIENT_EXTRACT_FREE_MONTHLY,
  ...
  agency_interview_prep: AGENCY_INTERVIEW_PREP_FREE_MONTHLY,
};
