 ...
 *   ・初めて Myaira を使う場合 → 新規登録(パスワード設定)リンク
 *   ・すでに Myaira アカウントがある場合 → ログインリンク
 * の 2 本立てで案内する。
 *
...
<div style="margin:20px 0 8px;padding:16px;background:#f6f7f9;border-radius:8px;">
  <p style="margin:0 0 6px;font-weight:600;font-size:14px;">初めて Myaira を使う方</p>
...
<div style="margin:8px 0 0;padding:16px;background:#f6f7f9;border-radius:8px;">
  <p style="margin:0 0 6px;font-weight:600;font-size:14px;">すでに Myaira アカウントをお持ちの方</p>
  <p style="margin:0 0 12px;font-size:13px;color:#555;line-height:1.6;">
    ログイン後に招待を受け入れてください。
  </p>
