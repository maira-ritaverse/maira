 ...
 *   4. 導入効果の数字 (ベンチマーク)
 *   5. CTA (トップの資料請求へ)
 * の構成で構築。動きは CSS animation で軽量に。
 *
 * Header / Footer は LP と統一する ため SiteHeader / SiteFooter を 使用。
 */
import type { Metadata } from "next";
import Link from "next/link";
import { Bell, Clock, FileText, MessageSquare, Sparkles, TrendingUp, Users } from "lucide-react";
