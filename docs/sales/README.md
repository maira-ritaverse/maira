...
| #   | ファイル                    | 内容                                               | 主な対象                      |
| --- | --------------------------- | -------------------------------------------------- | ----------------------------- |
| 1   | `01-executive-summary.md`   | 1ページで分かる Maira(経営層向け)                  | 経営者 / 役員                 |
| 2   | `02-market-and-pain.md`     | 業界課題 + Maira 選定理由                          | 経営者 / 管理職               |
...
5. ソースタイトルを分かりやすく(例:「Maira 経営層向け概要」「Maira 機能詳細」)
...
- 新人営業: NotebookLM に「Maira の営業トーク練習相手になって」 と頼んで対話練習
