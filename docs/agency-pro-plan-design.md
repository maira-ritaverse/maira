...
> **【SUPERSEDED】このドキュメント は 2026-06-20 に 確定 した
> `docs/agency-billing-design.md` で 完全に 置き換えられました。**
>
> 新仕様:
>
> - Standard ¥25,000 / 月(1〜3 人)+ ¥3,980 / 4 人目以降
> - - 録音 オプション ¥10,000 / + Pro ¥4,200 / + Premium ¥12,000(3 択 排他)
> - 初月 無料 + 年払い 10% OFF
>
> 本ファイル は 議論履歴 として 残しますが、 着手時 は
> `docs/agency-billing-design.md` を 参照 してください。
...
- **切替方式**:**手動 切替**(Myaira admin が 申込内容を 確認してから 切替)
