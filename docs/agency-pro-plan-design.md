...
| プラン     | 月次総量上限   | 想定 月次 コスト(最大)     | 推奨 月額           |
| ---------- | -------------- | -------------------------- | ------------------- |
| Free(既定) | 500 回         | 約 $5-15 (¥750-2,250)      | ¥0 / ¥3,000-5,000   |
| Pro        | 2,000-5,000 回 | 約 $25-100 (¥3,750-15,000) | ¥30,000-50,000 / 月 |

Pro 価格は **Zoom 録音解禁 + AI 上限引上** の セット 価値 で 設定。
...
1. 月額 価格(¥30,000-50,000 を 想定したが マーケ判断)
2. Pro 切替 タイミング:即時 / 翌月 から
3. Free → Pro 即解禁 vs 手動承認後 解禁
4. Stripe 導入 タイミング(Phase 3 か MVP からか)
