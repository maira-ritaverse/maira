...
| Product          | 用途                     | 課金 単位                          |
| ---------------- | ------------------------ | ---------------------------------- |
| Maira Standard   | Base プラン (3 席 込み)  | 月額 + 年額 の 2 Price             |
| Maira Extra Seat | Base 超過 分 の 追加 席  | 月額 + 年額 の 2 Price (1 席 単価) |
| Maira AI Boost   | Standard Pro 化 アドオン | 月額 + 年額 の 2 Price             |
